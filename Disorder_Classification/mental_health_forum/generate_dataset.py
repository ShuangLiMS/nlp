...
def main():
    file_names = {
        "anxiety": "./data/anxiety_threads_w_dialogs.csv",
        "bipolar": "./data/Bipolar_threads_w_dialogs.csv",
        "depression": "./data/depression_threads_w_dialogs.csv",
        "hearing_voices": "./data/Hearing Voices_threads_w_dialogs.csv",
        "PTSD": "./data/PTSD_threads_w_dialogs.csv",
        "Schizophrenia":"./data/Schizophrenia_threads_w_dialogs.csv",
        "self_harm": "./data/self-harm_threads_w_dialogs.csv"
    }
    ...
    #save them
    dataset.to_csv(open("dataset/label_and_description.csv", "w", errors='replace'))
    train_df.to_csv(open("dataset/train_label_and_description.csv", "w", errors='replace'))
    dev_df.to_csv(open("dataset/dev_label_and_description.csv", "w", errors='replace'))
    test_df.to_csv(open("dataset/test_label_and_description.csv", "w", errors='replace'))
